...
try
        {
            ...
            PreparedStatement consulta = conexion.prepareStatement("INSERT INTO jornada values ");
        ...
        catch(SQLException ex)
        {
            try {
                ...
                Logger.getLogger(editarjornada.class.getName()).log(Level.SEVERE, null, ex1);
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(editarjornada.class.getName()).log(Level.SEVERE, null, ex);
        }        // TODO add your handling code here:
