...
try
        {
            ...
            PreparedStatement consulta = conexion.prepareStatement("INSERT INTO temporada VALUES");
        ...
        catch(SQLException ex)
        {
            try {
                ...
                Logger.getLogger(editartemporada.class.getName()).log(Level.SEVERE, null, ex1);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editartemporada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editartemporada().setVisible(true);
            }
        });
    }
